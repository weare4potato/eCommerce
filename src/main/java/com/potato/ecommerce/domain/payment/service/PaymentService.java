...
import static com.potato.ecommerce.domain.payment.util.ExMessage.DB_ERROR_SAVE;
import static com.potato.ecommerce.domain.payment.util.ExMessage.MEMBER_ERROR_NOT_FOUND;
import static com.potato.ecommerce.domain.payment.util.ExMessage.PAYMENT_ERROR_ORDER;
import static com.potato.ecommerce.domain.payment.util.ExMessage.PAYMENT_ERROR_ORDER_AMOUNT;
import static com.potato.ecommerce.domain.payment.util.ExMessage.PAYMENT_ERROR_ORDER_NAME;
import static com.potato.ecommerce.domain.payment.util.ExMessage.PAYMENT_ERROR_ORDER_NOTFOUND;
import static com.potato.ecommerce.domain.payment.util.ExMessage.PAYMENT_ERROR_ORDER_PAY_TYPE;
import static com.potato.ecommerce.domain.payment.util.ExMessage.PAYMENT_ERROR_ORDER_PRICE;
...
import com.potato.ecommerce.domain.payment.dto.PaymentResHandleCardDto;
...
import com.potato.ecommerce.domain.payment.dto.PaymentResHandleVirtualDto;
...
import com.potato.ecommerce.domain.payment.repository.PaymentWebhookRepository;
...
public class PaymentService {
        ...
        try {
            ...
            memberRepository.findByEmail(customerEmail)
                .ifPresentOrElse(
                    ...
                    , () -> {
                        throw new BusinessException(MEMBER_ERROR_NOT_FOUND);
                    });
            ...
            throw new BusinessException(DB_ERROR_SAVE);
        }
    }
            ...
            .ifPresentOrElse(
                P -> {
                    ...
                    if (P.getAmount().equals(amount)) {
                        ...
                        throw new BusinessException(PAYMENT_ERROR_ORDER_AMOUNT);
                    }
                }, () -> {
                    throw new BusinessException(PAYMENT_ERROR_ORDER);
                }
            );
    }
    ...
    public PaymentResHandleDto requestFinalPayment(String paymentKey, String orderId, Long amount) {
        ...
        String encodedAuth = new String(
            Base64.getEncoder().encode((testSecretApiKey + ":").getBytes(
    ...
    public List<PaymentDto> getAllPayments(String memberEmail, PageRequest pageRequest) {
        String email = memberRepository.findByEmail(memberEmail)
            .orElseThrow(() -> new BusinessException(MEMBER_ERROR_NOT_FOUND))
            .getEmail();
    ...
    @Transactional(readOnly = true)
    public PaymentDto getOnePayment(String memberEmail) {
        String email = memberRepository.findByEmail(memberEmail)
            .orElseThrow(() -> new BusinessException(MEMBER_ERROR_NOT_FOUND))
            .getEmail();
